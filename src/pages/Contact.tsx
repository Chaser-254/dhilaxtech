                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#e30613] focus:border-transparent"
                    ...
                    <button
                      type="submit"
                      className="w-full bg-[#e30613] text-white py-3 px-4 rounded-md font-semibold hover:bg-[#c8102e] transition-colors"
                    >
                      Send Message
                    </button>
                  </form>
              ...
              <div className="bg-white shadow-lg rounded-lg p-8 h-full">
                ...
                <div className="mt-8">
                  ...
                  <div className="flex space-x-4">
                    <a
                      href="#"
                      className="bg-gray-100 hover:bg-[#e30613] hover:text-white text-gray-600 w-10 h-10 rounded-full flex items-center justify-center transition-colors"
                    >
